...
This is an MCP (Model Context Protocol) server that provides access to the CoinMarketCap Pro API. It enables AI agents and LLMs to interact with CoinMarketCap Pro through standardized tools.
...
```json
{
  ...
  "mcp_server": {
    ...
    "description": "Real-time cryptocurrency market data, quotes, rankings, and historical data from coinmarketcap",
